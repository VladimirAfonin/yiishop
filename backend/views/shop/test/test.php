...
//            WebPageHelper::prettyPrint($matches);exit(); // todo
            if(empty($matches[0])) {
...
//        var_dump($countDetailEndowmentItems);exit();
    }
//    WebPageHelper::prettyPrint($data['detailed_endowment']);exit(); // todo
...
$data['detailed_website_info']['is_equal'] = WebPageHelper::isWebsiteInfoEqual($matchesKP[0] ?? null, $websiteFromDB);
...
<table class="table table-bordered table-striped">
    ...
    <tbody>
    <tr>
        <td><span class="label label-default">Mark</span></td>
        <td><span class="label label-default">Mark</span></td>
