 ...
 */
class m180703_170800_create_product_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        $this->addForeignKey('fk-product-category_id', 'product', 'category_id', 'category','id','SET NULL', 'RESTRICT');
    }
