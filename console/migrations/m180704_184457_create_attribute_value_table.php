 ...
 */
class m180704_184457_create_attribute_value_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        $this->addPrimaryKey('pk-attribute_value-product_id', 'attribute_value',['product_id','attribute_id']);
