...
class ProductTag extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['tag_id'], 'exist', 'skipOnError' => true, 'targetClass' => TestTags::className(), 'targetAttribute' => ['tag_id' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(TestTags::className(), ['id' => 'tag_id']);
    }
}
